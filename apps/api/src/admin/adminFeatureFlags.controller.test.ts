...
describe('AdminFeatureFlagsController', () => {
  ...
  describe('getAll()', () => {
    it('should return all flags from the service', async () => {
      ...
      ;(mockFeatureFlagService.getAll as ReturnType<typeof vi.fn>).mockResolvedValue(flags as never)
    ...
    it('should return empty array when no flags exist', async () => {
      // Arrange
      ;(mockFeatureFlagService.getAll as ReturnType<typeof vi.fn>).mockResolvedValue([])
  ...
  describe('create()', () => {
    it('should create flag with valid data and log audit', async () => {
      ...
      ;(mockFeatureFlagService.create as ReturnType<typeof vi.fn>).mockResolvedValue(
        created as never
      )
    ...
    it('should throw FeatureFlagCreateFailedException when service returns null', async () => {
      ...
      ;(mockFeatureFlagService.create as ReturnType<typeof vi.fn>).mockResolvedValue(null as never)
    ...
    it('should throw FlagKeyConflictException when service throws unique constraint error', async () => {
      ...
      ;(mockFeatureFlagService.create as ReturnType<typeof vi.fn>).mockRejectedValue(dbError)
    ...
    it('should propagate unexpected errors from the service', async () => {
      ...
      ;(mockFeatureFlagService.create as ReturnType<typeof vi.fn>).mockRejectedValue(unexpected)
  ...
  describe('update()', () => {
    it('should update flag and log audit with before/after when name changes', async () => {
      ...
      ;(mockFeatureFlagService.getById as ReturnType<typeof vi.fn>).mockResolvedValue(
        before as never
      )
      ;(mockFeatureFlagService.update as ReturnType<typeof vi.fn>).mockResolvedValue(after as never)
    ...
    it('should throw FlagNotFoundException when service update returns null', async () => {
      ...
      ;(mockFeatureFlagService.update as ReturnType<typeof vi.fn>).mockResolvedValue(
        undefined as never
      )
  ...
  describe('delete()', () => {
    it('should delete flag and log audit with before state', async () => {
      ...
      ;(mockFeatureFlagService.delete as ReturnType<typeof vi.fn>).mockResolvedValue(undefined)

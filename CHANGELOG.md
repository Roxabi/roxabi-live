...
* **auth:** guided GitHub App install UX ([0cd5b40](https://github.com/Roxabi/roxabi-live/commit/0cd5b404ded2148727debb9f4c9169b0ace63520))
* **auth:** guided GitHub App install UX with pending sessions ([66bf746](https://github.com/Roxabi/roxabi-live/commit/66bf7464d88a7906cf3e1b09d080b693bc74fc9d))
...
* **graph:** server param for closed-under-open-epic filter ([0fed8e9](https://github.com/Roxabi/roxabi-live/commit/0fed8e9e7815d5279ce6d7a71d55ab61c1c3b54e))
* **graph:** server param for closed-under-open-epic filter ([158359e](https://github.com/Roxabi/roxabi-live/commit/158359ed2890b571d67edf9749af227e24c32de7))
...
* **security:** ZK ciphertext pipeline — seal titles client-side ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S2) ([9892c91](https://github.com/Roxabi/roxabi-live/commit/9892c911f2643584cd833493b4901743b27c1472))
* **security:** ZK ciphertext pipeline — seal titles client-side ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S2) ([fd96953](https://github.com/Roxabi/roxabi-live/commit/fd9695384b9ca0639d236b387920d5bac2fac907))
* **security:** ZK mode opt-in preference — API + UI ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S1) ([b848054](https://github.com/Roxabi/roxabi-live/commit/b848054185a254f859064aba8c6239dd7ba3973d))
* **security:** ZK mode opt-in preference — API + UI ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S1) ([77a6584](https://github.com/Roxabi/roxabi-live/commit/77a6584f5d1fc8c07abf94258f92ded9030fa138))
* **security:** ZK user token handoff + GitHub body sync ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S3) ([e7fe96e](https://github.com/Roxabi/roxabi-live/commit/e7fe96e0c5b40136e60da25c3006244f975d609b))
* **security:** ZK user token handoff + GitHub body sync ([#142](https://github.com/Roxabi/roxabi-live/issues/142) S3) ([b986551](https://github.com/Roxabi/roxabi-live/commit/b986551c6f206d81f7eec5ab79fb031d230478d7))
...
* **sync:** structure-only issue sync — no title/body on server path ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 6) ([9850652](https://github.com/Roxabi/roxabi-live/commit/9850652edc0eda141cdce88dc3da4f82dbbe826c))
...
* **worker:** scrub D1 plaintext titles for zk-sealed issues ([#142](https://github.com/Roxabi/roxabi-live/issues/142)) ([c0d47f2](https://github.com/Roxabi/roxabi-live/commit/c0d47f20f49659b1d5b502672784682df61b6cf1))
* **worker:** scrub D1 plaintext titles for zk-sealed issues ([#142](https://github.com/Roxabi/roxabi-live/issues/142)) ([402c710](https://github.com/Roxabi/roxabi-live/commit/402c710498e2faf326394deeb41c70ec38e3ea5a))
...
* **zk:** accept key_fp in payloads API with pubkey_fp dual-write ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 7) ([0189c4a](https://github.com/Roxabi/roxabi-live/commit/0189c4a271f61a7fb3136345e9f6fb1048dd2d31))
* **zk:** account-key multi-device encryption ([#216](https://github.com/Roxabi/roxabi-live/issues/216)) ([18acfbc](https://github.com/Roxabi/roxabi-live/commit/18acfbcaac5739ef8829cf2197ddc9b211fc82ba))
* **zk:** accountKey hierarchy with hash-wasm Argon2id ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 3) ([fee408c](https://github.com/Roxabi/roxabi-live/commit/fee408c1d9f7abd57ed8abcacc48ff12a27bb7dd))
* **zk:** add zk_key_backups migration and key_fp column ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 1) ([b519b41](https://github.com/Roxabi/roxabi-live/commit/b519b41b2342155f7772642c38eae7d81b5abedc))
* **zk:** GET/PUT /api/zk/key-backup with enroll guard and re-auth ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 2) ([43a66b1](https://github.com/Roxabi/roxabi-live/commit/43a66b157aab100cabbdec9c1f3862d6ccc5d8f8))
* **zk:** migrate legacy ECDH payloads to accountKey on enroll ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 5) ([2f4770d](https://github.com/Roxabi/roxabi-live/commit/2f4770d06d56fa079d98f66573351377667f129d))
* **zk:** multi-user UX, docs, and enrollment integration tests ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 8) ([2b591f1](https://github.com/Roxabi/roxabi-live/commit/2b591f165a2ca4808b54bd5610222c13d6dca1cd))
* **zk:** passphrase enrollment and lock screen ([#216](https://github.com/Roxabi/roxabi-live/issues/216) PR 4) ([8a7dc6e](https://github.com/Roxabi/roxabi-live/commit/8a7dc6e80e1fed3cd7f1be3d75cd788a6300d0ee))
* **zk:** private mode always on, redact by sealed keys ([76d90f8](https://github.com/Roxabi/roxabi-live/commit/76d90f8bd4212164f508e3987f4aff14c10c8af1))
* **zk:** reset encryption after lost passphrase ([e53a268](https://github.com/Roxabi/roxabi-live/commit/e53a26899ec7372dc05c5b095dd0ade89dcaaf46))
* **zk:** reset encryption after lost passphrase ([#216](https://github.com/Roxabi/roxabi-live/issues/216)) ([e26b61b](https://github.com/Roxabi/roxabi-live/commit/e26b61ba3782f3f80b88678a107ee7b34a6adb82))
* **zk:** reset encryption after lost passphrase ([#220](https://github.com/Roxabi/roxabi-live/issues/220)) ([e53a268](https://github.com/Roxabi/roxabi-live/commit/e53a26899ec7372dc05c5b095dd0ade89dcaaf46))
...
* **auth:** address install UX review findings ([b2cd4c0](https://github.com/Roxabi/roxabi-live/commit/b2cd4c01430df7ba378fe31dfd4427f7ab602a93))
...
* **auth:** fail-closed repo access when tenant is not linked ([1baf125](https://github.com/Roxabi/roxabi-live/commit/1baf1259df35eae4e067bdcb8a0931801742bc8b))
...
* **ci:** Node 22 for worker/deploy (wrangler 4) ([1ead65e](https://github.com/Roxabi/roxabi-live/commit/1ead65e5e5bdb6d825e0f2853a54ad22165784fe))
...
* **ci:** use Node 22 for worker/deploy jobs ([#156](https://github.com/Roxabi/roxabi-live/issues/156) fallout) ([c6c05ce](https://github.com/Roxabi/roxabi-live/commit/c6c05ce65c1ef84d767c24bbb423ae3f3a6cf2f4))
...
* **zk:** address PR [#217](https://github.com/Roxabi/roxabi-live/issues/217) pass-3 review warnings ([119dbab](https://github.com/Roxabi/roxabi-live/commit/119dbab1d2a3fe721e1765452efa469f32b08922))
* **zk:** address PR [#217](https://github.com/Roxabi/roxabi-live/issues/217) re-review blockers ([2f774f4](https://github.com/Roxabi/roxabi-live/commit/2f774f40544000fec35d79880e4d65a4c80611cd))
* **zk:** address PR [#217](https://github.com/Roxabi/roxabi-live/issues/217) review blockers ([fd119ef](https://github.com/Roxabi/roxabi-live/commit/fd119ef588b5eec7c278157bfd1f97eac274abce))
* **zk:** consume reauth proof before purge on reset ([ac3ac1d](https://github.com/Roxabi/roxabi-live/commit/ac3ac1d7bf280b3ca13999f4435a539a33f5bc85))
* **zk:** consume reauth proof before purge on reset ([#220](https://github.com/Roxabi/roxabi-live/issues/220)) ([cca0a6d](https://github.com/Roxabi/roxabi-live/commit/cca0a6de4e451519ab3306ebc3d85c433689ca47))
* **zk:** consume reauth proof before purge on reset ([#221](https://github.com/Roxabi/roxabi-live/issues/221)) ([ac3ac1d](https://github.com/Roxabi/roxabi-live/commit/ac3ac1d7bf280b3ca13999f4435a539a33f5bc85))
...
* **graph:** default ready/blocked server filter and flat grouping ([fd5ef8b](https://github.com/Roxabi/roxabi-live/commit/fd5ef8bc2cafced7ac351347f8e25b64440a0e89))
...
* add approved ZK account-key design spec ([#216](https://github.com/Roxabi/roxabi-live/issues/216)) ([2b266ee](https://github.com/Roxabi/roxabi-live/commit/2b266eeafb3241c957c049480dd9f72312762469))
...
* **s7:** mark CF Access cutover EXECUTED — verified live, not pending ([a0705e3](https://github.com/Roxabi/roxabi-live/commit/a0705e3beccd93879666c20de147f1ebef2e9671))
* **s7:** mark CF Access cutover EXECUTED (verified live, not pending) ([c335e4a](https://github.com/Roxabi/roxabi-live/commit/c335e4afddece4ccd22424a4274e03f5173315da))
